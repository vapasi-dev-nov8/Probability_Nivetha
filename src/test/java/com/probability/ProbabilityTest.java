...
public class ProbabilityTest {
    ...
    public void shouldGetProbabilityOfNotOccurredOutcome() {
        Probability probabilityOfEventA = new Probability(0.4);
        assertTrue(new Probability(0.6).equals(probabilityOfEventA.complement()));
    }
    ...
    public void shouldGetProbabilityOfTwoIndependentEventsOccurringTogether() {
        ...
        assertTrue(new Probability(0.20).equals(actualResult));
    }
